...
class TestSimulateDSM(unittest.TestCase):
    ...
    def test_simulateDSM_python(self):
        ...
        v, xn, xmax, y = ds._simulateDSM._simulateDSM_python(
            self.u, self.H, nlev=10.0, x0=0.0
        )
        v = v.reshape(-1)
        y = y.reshape(-1)
        self.assertTrue(np.allclose(v[:1200], self.v_ref[:1200], atol=1e-6, rtol=1e-4))
        self.assertTrue(np.allclose(y[:1200], self.y_ref[:1200], atol=1e-1, rtol=1e-2))
        v, xn, xmax, y = ds._simulateDSM._simulateDSM_python(
            self.u, self.ABCD, nlev=10, x0=0.0
        )
        v = v.reshape(-1)
        y = y.reshape(-1)
        self.assertTrue(np.allclose(v[:1200], self.v_ref[:1200], atol=1e-6, rtol=1e-4))
        self.assertTrue(np.allclose(y[:1200], self.y_ref[:1200], atol=1e-1, rtol=1e-3))
        self.assertTrue(np.allclose(xmax, self.xmax_ref, atol=1e-1, rtol=1e-1))
        self.assertTrue(
            np.allclose(xn[:, :1200], self.xn_ref[:, :1200], atol=1e-1, rtol=1e-3)
        )
    ...
    #         SkipTest = None
    #     if (
    #         ds._simulateDSM._simulateDSM_scipy_blas is None
    #         or ds._simulateDSM._simulateDSM_cblas is None
    #     ):
    #         if SkipTest is not None:
    #             raise SkipTest
    #         return
    #     vb, _, _, yb = ds._simulateDSM._simulateDSM_scipy_blas(
    #         self.u,
    #         self.H,
    #         nlev=10,
    #         x0=0.0,
    ...
    #         store_y=True,
    #     )
    #     vc, _, _, yc = ds._simulateDSM._simulateDSM_cblas(
    #         self.u,
    #         self.H,
    #         nlev=10,
    #         x0=0.0,
    ...
    #     vb, xnb, xmaxb, yb = ds._simulateDSM._simulateDSM_scipy_blas(
    #         self.u,
    #         self.ABCD,
    #         nlev=10,
    #         x0=0.0,
    ...
    #         store_y=True,
    #     )
    #     vc, xnc, xmaxc, yc = ds._simulateDSM._simulateDSM_cblas(
    #         self.u,
    #         self.ABCD,
    #         nlev=10,
    #         x0=0.0,
    ...
    #         store_y=True,
    #     )
    #     vc, _, _, yc = ds._simulateDSM._simulateDSM_python(
    #         self.u, self.H, nlev=10, x0=0.0
    #     )
    #     self.assertTrue(np.allclose(vb, vc, atol=1e-6, rtol=1e-4))
    #     self.assertTrue(np.allclose(yb, yc, atol=1e-6, rtol=1e-4))
    #     vb, xnb, xmaxb, yb = ds._simulateDSM._simulateDSM_scipy_blas(
    ...
    #         store_y=True,
    #     )
    #     vc, xnc, xmaxc, yc = ds._simulateDSM._simulateDSM_python(
    #         self.u, self.ABCD, nlev=10, x0=0.0
    #     )
    #     self.assertTrue(np.allclose(vb, vc, atol=1e-6, rtol=1e-4))
    #     self.assertTrue(np.allclose(xnb, xnc, atol=1e-6, rtol=1e-4))
    ...
    #             raise SkipTest
    #         return
    #     vb, _, _, yb = ds._simulateDSM._simulateDSM_cblas(
    #         self.u,
    #         self.H,
    #         nlev=10,
    #         x0=0.0,
    ...
    #     self.assertTrue(np.allclose(vb, vc, atol=1e-6, rtol=1e-4))
    #     self.assertTrue(np.allclose(yb, yc, atol=1e-6, rtol=1e-4))
    #     vb, xnb, xmaxb, yb = ds._simulateDSM._simulateDSM_cblas(
    #         self.u,
    #         self.ABCD,
    #         nlev=10,
    #         x0=0.0,
